    ...
    return (
        <>
            ...
            <div className= 'caja' style={{marginLeft: "200px"}}>
                <p>Save your <span style={{color:'#8db5ff'}}><b> gym progress </b> </span> easily and track your workouts.
                    Check your <span style={{color:'#8db5ff',}}> <b>routines</b></span>,
                    save your daily activity. Need motivation? Ask questions on the  <span style={{color:'#8db5ff',}}>
